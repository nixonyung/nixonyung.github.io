  ...
  if (flashcardSettings.words.functional.degree.value) {
    words.push(
      ...
      */
      ...
      { hiragana: "あまり", romanization: "amari", meaning: "not much", exampleUsages: ["あまり好きじゃありません (don't like it that much, polite)"] },
      ...
      { kanjis: ["-日"], hiragana: "にち", romanization: "nichi", meaning: "(counter for days)", exampleUsages: ['一日 ("ichinichi")'] },
